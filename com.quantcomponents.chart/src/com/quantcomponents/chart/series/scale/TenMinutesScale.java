...
/**
 * Generates ten minutes marks on a time axis
 */
public class TenMinutesScale extends TimeScale {

	public TenMinutesScale(TimeZone timeZone) {
		super(Calendar.MINUTE, 10, timeZone, 10L * 60L * 1000L);
	}
	...
	public IMark<Date> previousMark(Date date) {
		...
		int rem = cal.get(Calendar.MINUTE) % 10;
		if (rem > 0) {

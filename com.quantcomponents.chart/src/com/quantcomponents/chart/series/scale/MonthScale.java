...
/**
 * Generates month marks on a time axis
 */
public class MonthScale extends TimeScale {

	public MonthScale(TimeZone timeZone) {
		super(Calendar.MONTH, 1, timeZone, 30L * 24L * 60L * 60L * 1000L);
	}

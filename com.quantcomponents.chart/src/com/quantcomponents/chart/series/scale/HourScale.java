...
/**
 * Generates hourly marks on a time axis
 */
public class HourScale extends TimeScale {

	public HourScale(TimeZone timeZone) {
		super(Calendar.HOUR_OF_DAY, 1, timeZone, 60L * 60L * 1000L);
	}

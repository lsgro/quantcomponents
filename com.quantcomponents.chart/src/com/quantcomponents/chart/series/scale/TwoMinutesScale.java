...
/**
 * Generates two minutes marks on a time axis
 */
public class TwoMinutesScale extends TimeScale {

	public TwoMinutesScale(TimeZone timeZone) {
		super(Calendar.MINUTE, 2, timeZone, 2L * 60L * 1000L);
	}
